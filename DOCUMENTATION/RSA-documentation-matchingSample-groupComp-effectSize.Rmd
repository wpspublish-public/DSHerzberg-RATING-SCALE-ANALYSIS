...
In next section, we generate descriptive statistics for the SPM-2 scale *t*-scores in each sample, and then compare the mean *t*-scores with an effect-size measure.
