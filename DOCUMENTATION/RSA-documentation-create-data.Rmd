...
The item responses are coded `1-2-3-4` and summed to yield five raw scale scores: `CPS1_raw`, `CPS2_raw`, `CPS3_raw`, `CPS4_raw`, and `CPS5_raw`. The data set also includes simulated data for age, parental education level, ethnicity, geographic region, and clinical status. 
