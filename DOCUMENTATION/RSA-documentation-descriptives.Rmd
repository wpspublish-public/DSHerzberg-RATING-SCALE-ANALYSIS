...
The first section of this code is similar to the script for the item response frequency tables, so only the differing elements will receive commentary below.
