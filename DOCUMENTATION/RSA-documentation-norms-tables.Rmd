...
```
Next we apply the chosen normalization function to all of the raw score distributions in the input file, including total and subscale scores. As a reminder, the normalization functions require raw score distributions to be formatted not as data frame columns but as numerical vectors.
